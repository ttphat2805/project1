                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-custom">
                        <div class="contact-info-item">
                            ...
                            <div class="con-info-txt">
                                <h4>Địa chỉ</h4>
                                <p>FPoly công viên phần mềm Quang Trung - G6' Food Tân Chánh Hiệp </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-custom">
                    ...
                    <div class="col-lg-4 col-md-12 col-custom text-align-center">
                        <div class="contact-info-item">
                            ...
                            <div class="con-info-txt">
                                <h4>Email</h4>
                                <p>G6Food@gmail.com <br> info@example.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 col-custom">
                        <form method="post" action="assets/php/mail.php" id="contact-form" accept-charset="UTF-8" class="contact-form">
                            <div class="comment-box mt-5">
                                <h5 class="text-uppercase">Liên hệ ngay</h5>
                                <div class="row mt-3">
                                    <div class="col-md-6 col-custom">
                                        <div class="input-item mb-4">
                                            <input class="border rounded-0 w-100 input-area name" type="text" name="con_name" id="con_name" placeholder="Tên">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-custom">
                                        <div class="input-item mb-4">
                                    ...
                                    <div class="col-12 col-custom">
                                        <div class="input-item mb-4">
                                            <textarea cols="30" rows="5" class="border rounded-0 w-100 custom-textarea input-area" name="con_message" id="con_message" placeholder="Lời nhắn..."></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12 col-custom mt-40">
                                        <button type="submit" id="submit" name="submit" class="btn obrien-button primary-btn rounded-0 mb-0">Gửi ngay</button>
                                    </div>
