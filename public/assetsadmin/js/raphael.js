...
function() {
    ...
    var b, c = /[, ]+/,
        ...
        T = a._availableAttrs = { "arrow-end": "none", "arrow-start": "none", blur: 0, "clip-rect": "0 0 1e9 1e9", cursor: "default", cx: 0, cy: 0, fill: "#ff7675", "fill-opacity": 1, font: '10px "Arial"', "font-family": '"Arial"', "font-size": "10", "font-style": "normal", "font-weight": 400, gradient: 0, height: 0, href: "http://raphaeljs.com/", "letter-spacing": 0, opacity: 1, path: "M0,0", r: 0, rx: 0, ry: 0, src: "", stroke: "#ff7675", "stroke-dasharray": "", "stroke-linecap": "butt", "stroke-linejoin": "butt", "stroke-miterlimit": 0, "stroke-opacity": 1, "stroke-width": 1, target: "_blank", "text-anchor": "middle", title: "Raphael", transform: "", width: 0, x: 0, y: 0 },
    ...
    k.getElementByPoint = function(a, b) {
        ...
        a = a || {};
        var b = { width: (a.width || 10) + (+this.attr("stroke-width") || 1), fill: a.fill || !1, opacity: a.opacity || .5, offsetx: a.offsetx || 0, offsety: a.offsety || 0, color: a.color || "red" },
            c = b.width / 2,
            d = this.paper,
            e = d.set(),
    ...
    cH.attr = function(b, c) {
            ...
            return this.path(m).attr({ fill: "#ff7675", stroke: "none" })
        }, k.add = function(b) {
            if (a.is(b, "array")) {
                var c = this.set(),
                    e = 0,
    ...
    z.prototype = A, A.constructor = z, a._engine.path = function(a, b) {
        ...
        var d = new z(c, b);
        d.type = "path", w(d, { fill: "none", stroke: "#ff7675", path: a });
        return d
        ...
        var f = new z(e, a);
        f.attrs = { cx: b, cy: c, r: d, fill: "none", stroke: "#ff7675" }, f.type = "circle", q(e, f.attrs);
        return f
    }, a._engine.rect = function(a, b, c, d, e, f) {
        var g = q("rect");
        a.canvas && a.canvas.appendChild(g);
        var h = new z(g, a);
        h.attrs = { x: b, y: c, width: d, height: e, r: f || 0, rx: f || 0, ry: f || 0, fill: "none", stroke: "#ff7675" }, h.type = "rect", q(g, h.attrs);
        return h
    ...
    D.prototype = E, E.constructor = D, E.transform = function(b) {
        ...
        var k = new D(h, b),
            l = { fill: "red", stroke: "none", font: a._availableAttrs.font, text: g };
